...
test("ThreadStarted", () => {
  expect(Reflect.getMetadata(PATTERN_METADATA, tester.ThreadStarted))
    .toBeInstanceOf(Array);
});

test("ThreadContextChanged", () => {
  expect(Reflect.getMetadata(PATTERN_METADATA, tester.ThreadContextChanged))
    .toBeInstanceOf(Array);
});

test("UserMessage", () => {
  expect(Reflect.getMetadata(PATTERN_METADATA, tester.UserMessage))
    .toBeInstanceOf(Array);
});
